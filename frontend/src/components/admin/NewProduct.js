...
export  default function NewProduct () {
    ...
    const submitHandler = (e) => {
        ...
        formData.append('rtprice' , rtprice);
                ...
                <Fragment>
                    <div className="wrapper my-5"> 
                        <form onSubmit={submitHandler} className="shadow-lg" encType='multipart/form-data'>
                            ...
                            <div className="form-group">
                                <label htmlFor="rtprice_field">Our Price</label>
                                <input
                                    type="text"
                                    id="rtprice_field"
                                    className="form-control"
                            ...
                            <div className="form-group">
                                ...
                                <select onChange={e => setType(e.target.value)} className="form-control" id="type_field">
                                    <option value="">Select</option>
                                    {typesByCategory[category] && typesByCategory[category].map(type => (
